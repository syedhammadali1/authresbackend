<?php
 $unreadNotification = auth()->user()->notifications->whereNull('read_at');
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu p-0" aria-labelledby="notificationDropdown">
                    <div class="px-3 py-2 d-flex align-items-center justify-content-between border-bottom">
                        <p>{{ $unreadNotification->count() }} New Notifications</p>
                    </div>
                    <div class="p-1">
                        ...
                        <li class="dropdown-item py-2">
                            {{-- <a href="javascript:;" class="text-body ms-0"> --}}
                                <form action="{{ route('logout') }}" method="post" id="delete-form">
                                    ...
                                    <span onclick="document.forms['delete-form'].submit();">Log Out</span>
