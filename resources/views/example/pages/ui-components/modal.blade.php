    ...
    <div class="row">
        <div class="col-xl-10 main-content ps-xl-4 pe-xl-5">
            ...
            <p class="lead">Add dialogs to your site for lightboxes, user notifications, or completely custom content. Read
                the <a href="https://getbootstrap.com/docs/5.1/components/modal/" target="_blank">Official Bootstrap
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary">Save changes</button>
            ...
            <div class="example">
                ...
                <button type="button" class="btn btn-primary mb-1 mb-md-0" data-bs-toggle="modal"
                    data-bs-target="#varyingModal" data-bs-whatever="@fat">Open modal for @fat</button>
                <button type="button" class="btn btn-primary mb-1 mb-md-0" data-bs-toggle="modal"
                    data-bs-target="#varyingModal" data-bs-whatever="@getbootstrap">Open modal for @getbootstrap</button>
...
varyingModal.addEventListener('show.bs.modal', function (event) {
  ...
  modalBodyInput.value = recipient
                ...
                <button type="button" class="btn btn-clipboard"
                    data-clipboard-target="#varyingContentScript">copy</button>
            </figure>
